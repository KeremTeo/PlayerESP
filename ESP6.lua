...
function CreateEsp(Player)
    local Box,BoxOutline,Name,HealthBar,HealthBarOutline,DF,StaminaBar = Drawing.new("Square"),Drawing.new("Square"),Drawing.new("Text"),Drawing.new("Square"),Drawing.new("Square"),Drawing.new("Text"),Drawing.new("Square")
    ...
    if Player.Character ~= nil and Player.Character:FindFirstChild("Humanoid") ~= nil and Player.Character:FindFirstChild("HumanoidRootPart") ~= nil and Player.Character.Humanoid.Health > 0 and Player.Character:FindFirstChild("Head") ~= nil then
            ...
            if Config.StaminaBar then
                ...
                StaminaBarOutline.Color = Color3.fromRGB(0,0,0)
                StaminaBarOutline.Filled = true
                StaminaBarOutline.ZIndex = 1
    
                StaminaBar.Visible = IsVisible
                StaminaBar.Color = Color3.fromRGB(255,0,0):lerp(Color3.fromRGB(0,255,0), repfolder.Stamina.Value/repfolder.Stamina.MaxValue)
                ...
                elseif Config.StaminaBarSide == "Bottom" then
                    StaminaBarOutline.Size = Vector2.new(width,3)
                    ...
                    StaminaBar.Size = Vector2.new((StaminaBarOutline.Size.X - 2) * (repfolder.Stamina.Value/repfolder.Stamina.MaxValue),1)
                    StaminaBar.Position = StaminaBarOutline.Position + Vector2.new(1,-1 + StaminaBarOutline.Size.Y)
